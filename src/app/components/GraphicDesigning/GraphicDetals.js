export default function GrahicDetails() {
    return (
      <div className="flex flex-col gap-10 mt-10 md:flex-row items-center max-w-5xl mx-auto">
        {/* Left Side - Image */}
        <div className="md:w-1/2 w-full h-full flex items-center justify-center slide-left">
          <img
            src="/images/graphics1.JPG" // Replace with your image path
            alt="Team Meeting"
        ...
        <div className="md:w-1/2 w-full p-6 slide-right">
          <h2 className="text-3xl font-bold leading-10 text-black">
            Top <span className="text-[#33CCC5]">Graphic Designing </span>
